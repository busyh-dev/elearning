                ...
                <div class="row -mt-24  row-gap-24">
                    <div class="col-lg-4 col-sm-6 d-flex">
                        <div class="featured-card d-flex align-items-center w-100">
                            ...
                            <div class="content">
                                <h4>50.000 +Corso Online</h4>
                                <p>Goditi l'accesso a vita ai corsi</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 d-flex">
                        <div class="featured-card d-flex align-items-center w-100">
                            ...
                            <div class="content">
                                ...
                                <p>Impara dagli esperti del settore</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-sm-6 d-flex">
                        <div class="featured-card d-flex align-items-center w-100">
                            ...
                            <div class="content">
                                <h4>Accesso illimitato</h4>
                                <p>Impara secondo il tuo programma</p>
                            </div>
                        </div>
                    </div>
                </div>
