...
Route::post('check-user-identity', 'Auth\ForgotPasswordController@checkUserIdentity')->name('checkUserIdentity');
Route::post('reset-password-direct', 'Auth\ForgotPasswordController@resetPasswordDirect')->name('resetPasswordDirect');
