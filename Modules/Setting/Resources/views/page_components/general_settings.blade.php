                    ...
                    <div class="row">
                        <div class="col-xl-12">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" placeholder="Alethèia CRM" type="text" id="site_title"
                        ...
                        <div class="col-xl-6">
                            <div class="primary_input mb-25">
                                ...
                                <input class="primary_input_field" placeholder="demo@aletheiasrl.it" type="email" id="email"
...
{{--                        </div>--}}
            ...
            @php
                ...
                $hasPermission=false;
                if(!permissionCheck('settings.general_setting_update')){
                    $tooltip = "Non hai il permesso per inserire";
                }else{
                    $hasPermission=true;
                }
