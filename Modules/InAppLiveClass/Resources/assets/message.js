...
(function ($) {
    ...
    const chatItemHtml = (message, memberName, date) => {
        return `<div class="chat-card mt-25 mx-15">
            <div>
                ...
                <span class="ml-5 ps-5 border-left font-12 text-gray border-gray200">${date}</span>
            </div>

            <p class="bg-gray200 p-15 text-gray font-14 fw-500 mt-1 rounded-sm">${message}</p>
        </div>`;
    };
    ...
    const joinedHtml = (username) => {
        return `<div class="user-card d-flex align-items-center border border-gray200 p-15 mx-15 mt-25 rounded-sm">
            ...
            <div class="ml-10">
                <span class="font-14 fw-500 d-block text-dark">${username}</span>
