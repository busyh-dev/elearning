            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-6">
                    <div class="about-content">
                        <h3>Siamo il miglior istituto di apprendimento aziendale</h3>
                        <p>Dal 2008 e ora nel 2019 "Spondon It" è la società fornitrice di servizi correlati a UI e UX, sviluppo di app Web, marketing digitale e progettazione grafica più popolare, sia locale (Italy) che globale!</p>
                        <p>In un momento in cui stiamo anche facendo del nostro meglio per i nostri clienti offrendo il nostro servizio. Questo ci dà un aumento di popolarità in questo mondo della tecnologia digitale.</p>
                        <ul class="mb-4 mb-lg-5">
                            <li class="d-flex flex-wrap">
                                ...
                                <span class="content">Esplora l'ampia gamma di corsi online nel mondo</span>
                            </li>
                            <li class="d-flex flex-wrap">
                                        <span class="icon text-primary">
                                        <svg width="26" height="26" viewBox="0 0 26 26" fill="none"
                                ...
                                <span class="content">Corso online più popolare al mondo</span>
                            </li>
                        </ul>
                        <a href="#" class="theme-btn">Scopri di più</a>
                    </div>
                </div>
            </div>
        </div>
