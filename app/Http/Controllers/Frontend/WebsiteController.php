        ...
        try {
            ...
            if ($isEnrolled || $enrollForCpd || $enrollForClass || $enrollForMembership) {
                ...
                if (!empty($lesson_id)) {                   
                    ...
                    // 👉 Salva log nella tabella scorm_reports
                    ScormReport::create([
                        'user_id' => $user->id,
                        'course_id' => $course->id,
                        'lesson_id' => $lesson_id,
                        ...
                        'component' => 'Start',
                        'event' => 'Lesson Opened',
                        'description' => 'User started SCORM lesson from continueCourse',
                        'orgin' => 'LMS',
                        // 'ip_url' => request()->fullUrl(),
                        'ip_url' => url("elearning/fullscreen-view/{$course->id}/{$lesson_id}"),
                        'slide_number' => 1,
                        'time_spent' => 0,
                        'completion_status' => 'incomplete',
                        'lesson_location' => null, // O un valore iniziale (es: "start" o "")               
